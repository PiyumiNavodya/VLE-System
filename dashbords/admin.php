            ...
            <div class="cards-container">
                ...
                <div class="card">
                    ...
                    <button class="card-button">
                        Manage Schedules <i class="fas fa-arrow-right"></i>
                    </button>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="anousment.html" class="card-button">
                ...
                <div class="card">
                    ...
                    <p>Configure semester dates and maintenance.</p>
                    <button class="card-button">
                        System Settings <i class="fas fa-arrow-right"></i>
                    </button>
                </div>
            </div>
        </main>
